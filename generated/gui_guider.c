...
const uint8_t in_channel_label[][8] =
{
  {"IN A"},
  {"IN B"},
  {"IN C"},
...
const uint8_t out_channel_label[][8] =
{
  {"OUT1"},
  {"OUT2"},
  {"OUT3"},
...
void init_scr_del_flag(lv_ui *ui)
{
	...
	ui->load_page_del = true;
	ui->main_page_del = true;
	ui->standby_page_del = true;
	ui->menu_page_del = true;
	ui->volume_page_del = true;
	ui->preset_page_del = true;
	ui->source_page_del = true;
	ui->status_page_del = true;
	ui->rename_page_del = true;
	ui->ipset_page_del = true;
	ui->info_page_del = true;
	ui->screen_page_del = true;
}

void setup_ui(lv_ui *ui)
{
	init_scr_del_flag(ui);
	setup_scr_load_page(ui);
	lv_scr_load(ui->load_page);
}

/*
void set_channel_name_style(lv_style_t* style)
{
  lv_style_set_text_font(style, &lv_font_montserratMedium_18);
  lv_style_set_border_width(style, 2);
  lv_style_set_border_color(style, lv_color_white());
  lv_style_set_radius(style, 2);
  lv_style_set_bg_color(style, DESIGNATED_COLOR_BLUE);
  lv_style_set_bg_opa(style,  LV_OPA_COVER);
  lv_style_set_text_color(style, MAIN_FONT_COLOR);
...
{
  lv_obj_set_style_text_font(obj, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_bg_color(obj, DESIGNATED_COLOR_BLUE, LV_PART_MAIN|LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(obj,  LV_OPA_COVER, LV_PART_MAIN|LV_STATE_DEFAULT);
  lv_obj_set_style_text_color(obj, MAIN_FONT_COLOR, LV_PART_MAIN|LV_STATE_DEFAULT);
